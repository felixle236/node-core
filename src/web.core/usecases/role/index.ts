...
import { FindRoleCommonHandler } from './FindRoleCommonHandler';
import { FindRoleHandler } from './FindRoleHandler';
import { GetRoleByIdHandler } from './GetRoleByIdHandler';
import { IRoleInteractor } from '../interfaces/interactors/IRoleInteractor';
import { ResultList } from '../../domain/common/output/ResultList';
import { Role } from '../../domain/entities/Role';
import { Service } from 'typedi';
import { SystemError } from '../../dtos/common/Exception';
import { UpdateRoleHandler } from './UpdateRoleHandler';
...
export class RoleInteractor implements IRoleInteractor {
    constructor(
        private _findRoleHandler: FindRoleHandler,
        private _findRoleCommonHandler: FindRoleCommonHandler,
        private _getRoleByIdHandler: GetRoleByIdHandler,
        private _createRoleHandler: CreateRoleHandler,
        private _updateRoleHandler: UpdateRoleHandler,
        private _deleteRoleHandler: DeleteRoleHandler
    ) {}

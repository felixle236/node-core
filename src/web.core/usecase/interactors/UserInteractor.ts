...
import { IMailService } from '../boundaries/services/IMailService';
import { IRoleRepository } from '../boundaries/data/IRoleRepository';
import { IStorageService } from '../boundaries/services/IStorageService';
import { IUserInteractor } from '../boundaries/interactors/IUserInteractor';
...
export class UserInteractor implements IUserInteractor {
    ...
    async find(filter: UserFilterRequest, userAuth: UserAuthenticated): Promise<ResultList<UserResponse>> {
    ...
    async findCommon(filter: UserCommonFilterRequest, userAuth: UserAuthenticated): Promise<ResultList<UserCommonResponse>> {
        filter.userAuth = userAuth;

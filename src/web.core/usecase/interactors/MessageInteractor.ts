...
import { IMemberStatusRepository } from '../boundaries/data/IMemberStatusRepository';
import { IMessageInteractor } from '../boundaries/interactors/IMessageInteractor';
import { IMessageRepository } from '../boundaries/data/IMessageRepository';

...
const getClientByIdQueryHandler = Container.get(GetClientByIdQueryHandler);
...
describe('Client - Get client by id', () => {
    ...
    it('Get client by id with not found error', async () => {
        ...
        const error = await getClientByIdQueryHandler.handle(dataTest.id).catch(error => error);
    ...
    it('Get client by id', async () => {
        ...
        const result = await getClientByIdQueryHandler.handle(dataTest.id);

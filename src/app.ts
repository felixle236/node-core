...
import { ENABLE_MOBILE_API, ENABLE_SWAGGER_UI, ENABLE_WEB_API, ENABLE_WEB_SOCKET, ENABLE_WEB_UI, ENVIRONMENT, MOBILE_API_PORT, MOBILE_API_URL, PROJECT_NAME, SWAGGER_UI_PORT, SWAGGER_UI_URL, WEB_API_PORT, WEB_API_URL, WEB_SOCKET_PORT, WEB_SOCKET_URL, WEB_UI_PORT, WEB_UI_URL } from 'config/Configuration';

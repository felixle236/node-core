import 'infras/services/log/LogService';
import 'infras/services/storage/StorageService';
...
const logService: ILogService = Container.get(InjectService.Log);
const storageService: IStorageService = Container.get(InjectService.Storage);
